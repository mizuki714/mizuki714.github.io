...
fetch(forecastURL)
    ...
    .then((jsObject) => {
        ...
        for (let day = 0; day < daily.length; day++) {
            ...
            const milliseconds = daily[day].dt * 1000;
            ...
            for (let i = 0; i < forecastTemp.length; i++) {
                ...
                forecastTemp[day].innerHTML = daily[day].temp.day + "&#8457;";
            ...
            for (let i = 0; i < weatherIcon.length; i++) {
                ...
                weatherIcon[day].setAttribute("src", `https://openweathermap.org/img/wn/${daily[day].weather[0].icon}@2x.png`);
                weatherIcon[day].setAttribute("alt", `Icon representing ${daily[day].weather[0].description}`);
...
/*
    ORIGINAL CODE THAT WORKED AND THEN DIDNT BECAUSE I HAD IT SET TO DO THE DAY AFTER CURRENT DATE
